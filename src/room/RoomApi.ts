...
router.post(
  ...
  <RequestHandler>async function (req: UserRequest, res, next) {
    try {
      const result = await RoomManager.create({
        ...req.body,
...
router.get(
  ...
  <RequestHandler>async function (req, res, next) {
    try {
      const result = await RoomManager.getUserRooms({
...
router.post(
  ...
  <RequestHandler>async function (req, res, next) {
    try {
      const updatedUser = await RoomManager.changeHost(
        req.params.roomId,
        req.body.newHost
      );
...
router.post(
  ...
  <RequestHandler>async function (req: UserRequest, res, next) {
    try {
      const result = await RoomManager.joinOrLeaveRoom({
