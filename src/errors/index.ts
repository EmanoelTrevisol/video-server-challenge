export default {
  room: {
    ...
    HOST_UNABLE_LEAVE_ROOM:
      'You cannot leave the room because you are the host. Change the host before leaving the room.',
    ROOM_HOST_INEXISTENT:
      'The new host was not found. Please inform an existent user',
    USER_NOT_IN_ROOM: 'The informed user is not in this room',
    NEW_HOST_INEXISTENT:
      'The new host informed was not found. Please inform a valid user in the room',
    USER_ALREADY_HOST:
      'The informed user is already the host of this room. If you wish to change the host, please inform another user',
  ...
  user: {
    ...
    USERNAME_ALREADY_EXISTS:
      'This username already exists in our database. Please provide another',
    WRONG_CREDENTIALS:
